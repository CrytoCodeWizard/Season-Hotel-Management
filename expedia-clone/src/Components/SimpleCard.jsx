import { Box, Button, Center, Heading, Image, Text, Stack } from '@chakra-ui/react'
            ...
            <Center >
                <Stack w='80%' direction={['column', 'row']} spacing='24px'>
                    <Box padding='auto' alignItems='center' rowSpan={2} colSpan={1}  >
                        <Image boxSize={{ base: "70px", sm: "120px", md: "190px" }} w='100%' src={src} />
                    </Box>

                    <Box w='400px' paddingTop='20px' textAlign='left' marginLeft='10px' colSpan={2}  >
                    ...
                    <Box paddingTop='40px' colSpan={2} >
                        ...
                        <Text fontWeight='bold' fontSize='13px'>Price: {price}</Text>
                    </Box>
                </Stack>
            </Center>
        </Box>
