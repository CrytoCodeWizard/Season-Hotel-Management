...
const CheckoutPage = () => {
  ...
  return (
    ...
    <div style={{ width: "100%", height: "auto", backgroundColor: "#f8f5f4" }}>
        ...
        >
          ...
          <Box  textAlign="left">
            <Text fontSize="13px" fontWeight="bold">
              {" "}
              Free cancellation before Tue, 22 Nov, 14:00 (property local time)
            </Text>
            <Text fontSize="13px">
                ...
                <Box marginLeft="50px" marginTop="60px" textAlign="left">
                  ...
                  <Text fontSize="13px">
                    ...
                    <Link>
                      ...
                      in a new window, and Expedia Rewards Terms and Conditions.
                    </Link>{" "}
                  </Text>
                  <Box marginTop={"20px"} textAlign={"left"}>
                    ...
                    >
                      <li>
                        ...
                        local time) on 22 Nov 2022 or no-shows are subject to a
                        property fee equal to 100% of the total amount paid for
                        the reservation.
                      </li>
                      <li>
                        ...
                        arrival. At check-in, guests must provide a record of
                        full COVID-19 vaccination. Guests providing vaccine
                        records must have received complete COVID-19 vaccination
                        at least 3 days prior to check-in. For more details,
                        please contact the property using the information on the
                        booking confirmation.
                      </li>
                      <li>
                        This property requires guests to confirm their check-out
                        date at check-in. Any modifications to the check-out
                        date will incur a fee. Early departure fees apply if
                        notice not provided; not applicable for non-refundable
                        rates.
                      </li>
                      <li>
                        To register at this property, guests who are Indian
                        citizens must provide a valid photo identity card issued
                        by the Government of India; Permanent Account Number
                        (PAN) cards will not be accepted due to national
                        regulations. Travelers who are not citizens of India
                        must present a valid passport and visa. Indian citizens
                        must show a PAN card at check-out for cash transactions
                        exceeding INR 25,000.
                      </li>
                      <li>
                        Please note that Expedia and the hotel will not issue a
                        tax invoice. You will receive a commercial receipt for
                    ...
                    <Box marginTop={"50px"}>
                      <Text fontSize="13px">
                        ...
                        <Link>
                          ...
                          Opens in a new window. and Terms of Use Opens in a new
                          window..
                        </Link>
                      </Text>
                    </Box>
                  ...
                  <Text fontSize="13px" marginTop={"15px"}>
                    This payment will be processed in India. This does not apply
                    when the travel provider (airline/hotel/rail, etc.)
            ...
            >
              ...
              <Box m="25px" marginTop={"30px"}>
                ...
                <Text fontSize={"13px"}>
                  ...
                  Hotels). We retain our service fee for facilitating your
                  travel reservation. For details please see our terms of use.
                </Text>
              </Box>
            </Box>
          </Stack>
