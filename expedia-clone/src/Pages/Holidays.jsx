    ...
    <div>
      <Center>
        <Box textAlign={"left"} w={"80%"}>
          <Heading p={"20px"}>Search holiday packages</Heading>
        </Box>
      </Center>
      <SearchBar />
      <Center>
        <Box textAlign={"left"} w={"80%"}>
          <Heading p="20px">Top Holiday Destinations</Heading>
        </Box>
      </Center>
      <Center>
        <Box
      ...
      <Text fontSize={"25px"} fontWeight="bold" align="left" my='10px' marginLeft="10%">
